...
這一部分的示範，將引導您逐步了解將 Microsoft Sentinel 連線至資料來源以開始收集資料的流程。
...
在此部分的示範中，會逐步引導您進行 Office 365 活頁簿的設定流程，以視覺化和監視您的資料。
...
### <a name="demo-part-5"></a>示範第 5 部分

在此部分的示範中，會對部分 Azure Sentinel 中的選項加以說明。
